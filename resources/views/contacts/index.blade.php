  ...
  <div class="container">
    @forelse ($contacts as $contact)
      <div class="d-flex justify-content-between bg-dark mb-3 rounded px-4 py-2">
        <div>
            <a href="{{ route('contacts.show', $contact->id) }}" class="text-decoration-none text-white">
            <img src="https://cdn-icons-png.flaticon.com/512/1077/1077114.png" alt="contact icon" width="30" height="30">
            </a>
        </div>
